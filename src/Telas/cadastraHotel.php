...
<head>
    ...
    <title>SGH - Cadastro de Hotel</title>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-black">Cadastro de hotel</h3>
                    <?php if(isset($_SESSION['erro_BD'])): ?>
                        <div class="notification is-danger">
                            <p>ERRO: Hotel não foi inserido no banco de dados. Favor entrar em contato com o administrador do sistema.</p>
                        </div>
                    <?php endif;
                    ...
                    <?php if(isset($_SESSION['correto'])): ?>
                        <div class="notification is-success">
                            <p>Hotel inserido no banco de dados corretamente.</p>
                        </div>
                    <?php endif;
                        unset($_SESSION['correto']); ?>

                    <div class="box">
                        <form action="cadastraHotelBD.php" method="post">
                            <div class="field">
                                <p>Nome do hotel<input type="text" class="input is-large" name="nomehotel" autofocus=""/></p>
                            </div>
                            <div class="field">
                                <p>Localização<input type="text" class="input is-large" name="localhotel" autofocus=""/></p>
                            </div>
                            <div class="field">
