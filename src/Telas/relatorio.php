                    ...
                    <div class="navbar-item">
                        <div class="buttons">
                            <?php if(isset($_SESSION['administrador'])): 
                                echo "<p>".$_SESSION['administrador']."</p>";?>
                        ...
                        <?php
                            ...
                            //if($total > 0) {
                                ...
                                //do {
                                    ...
                                    $usuario=$_SESSION['usuario'];
                                    // cria a instrução SQL que vai selecionar os dados
                                    $query = sprintf("SELECT H.nome, L.local_hotel, COUNT(U.cpf) as Total_clients
                                    ...
                                    //$dados = mysqli_query($conexao,$query) or die(mysqli_error());
                                    if ($dados = mysqli_query($conexao, $query)){
                                        echo "<p> Total de clientes (por hotel)</p><br>";
                                        echo "<p> Nome Hotel | Local Hotel |Diarias</p><br>";
                                        while ($linha = mysqli_fetch_assoc($dados)) {
                                            //printf ("%s (%s)\n", $linha["cod_cupom"], $row["valor_desconto"]);
                                            echo "<p>". $linha['nome'] . "  |  ". $linha['local_hotel'] . "  |  ". $linha['Total_clients'] ."</p>";
                                        }
                                        mysqli_free_result($dados);
                                    }
