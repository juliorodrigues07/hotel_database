        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-black">Cadastro de feriado</h3>
                    <?php if(isset($_SESSION['erro_BD'])): ?>
                        <div class="notification is-danger">
                            <p>ERRO: Feriado não foi inserido no banco de dados. Favor entrar em contato com o administrador do sistema.</p>
                        </div>
                    <?php endif;
                        unset($_SESSION['erro_BD']); ?>
                    <?php if(isset($_SESSION['erro_cpf'])): ?>
                        <div class="notification is-danger">
                            <p>ERRO: Feriado não inserido no banco de dados. Favor verificar o número do CPF.</p>
                        </div>
                    <?php endif;
                        unset($_SESSION['erro_cpf']); ?>
                    <?php if(isset($_SESSION['correto'])): ?>
                        <div class="notification is-success">
                            <p>Feriado inserido no banco de dados corretamente.</p>
                        </div>
                    <?php endif;
                        unset($_SESSION['correto']); ?>

                    <div class="box">
                        <form action="cadastraFeriadoBD.php" method="post">
                            <div class="field">
                                <p>Nome<input type="text" class="input is-large" name="nome" autofocus=""/></p>
                            </div>
                            <div class="field">
