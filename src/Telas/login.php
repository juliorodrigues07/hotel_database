...
<head>
    ...
    <title>SGH - Sistema Gerenciador de Hotel</title>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-black">SGH</h3>
                    <h3 class="title has-text-black"><target="_blank">Sistema Gerenciador de Hotéis</a></h3>
