        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-black">Cadastro de quarto</h3>
                    <?php if(isset($_SESSION['erro_BD'])): ?>
                        <div class="notification is-danger">
                            <p>ERRO: Quarto não foi inserido no banco de dados. Favor entrar em contato com o administrador do sistema.</p>
                        </div>
                    <?php endif;
                        unset($_SESSION['erro_BD']); ?>
                    <?php if(isset($_SESSION['correto'])): ?>
                        <div class="notification is-success">
                            <p>Quarto inserido no banco de dados corretamente.</p>
                        </div>
                    <?php endif;
                        unset($_SESSION['correto']); ?>

                    <div class="box">
                        <form action="cadastraQuartoBD.php" method="post">
                            <div class="field">
                                <p>Número do quarto<input type="text" class="input is-large" name="numero" autofocus=""/></p>
                            </div>
                            <div class="field">
                                <p>Descrição<input type="text" class="input is-large" name="descricao" autofocus=""/></p>
                            </div>
                            <div class="field">
                                <p>Tipo do quarto<input type="text" class="input is-large" name="tipo" autofocus=""/></p>
                            </div>
                            <div class="field">
                                <p>Status do quarto<input type="text" class="input is-large" name="status" autofocus=""/></p>
                            </div>
                            <div class="field">
